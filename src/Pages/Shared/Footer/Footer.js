...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-neutral text-neutral-content">
            <div>
                <img width="100" height="100" viewBox="0 0 24 24" src={image} alt="" />
                <p>Avi Photography<br />Providing reliable tech since 2015</p>
                <p>Copyright © 2022 - All right reserved</p>
            </div>
            <div>
                <span className="footer-title">Contact with Social Media</span>
